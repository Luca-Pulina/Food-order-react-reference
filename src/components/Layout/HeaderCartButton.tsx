...
const HeaderCartButton = ({ text, children, items = 0 }: Props) => {
	return (
		<button className='p-1 px-3 flex justify-between items-center bg-purple-500 rounded-2xl px-2 w-[9rem] h-8 text-white hover:bg-purple-600 hover:shadow-sm hover:shadow-purple-300'>
			<CartIcon />
